(function () {
    ...
    angular
        .module('app')
        .factory(serviceId, ['model.validation', model]);
        ...
        function registerTimeSlot(metadataStore) {
            ...
            Object.defineProperty(TimeSlot.prototype, 'name', {
                get: function () {
                    ...
                    var value = ((start - nulloDate) === 0 ? ' [Select a timeslot]' : (start && moment.utc(start).isValid()) ? moment.utc(start).format('ddd hh:mm a') : ' [Unknow]') ;
                    return value;
                }
            });
